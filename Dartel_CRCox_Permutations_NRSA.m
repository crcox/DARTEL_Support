...
permutationsdir = 'D:\MRI\SoundPicture\results\WholeBrain_RSA\wholebrain\semantic\featurenorms\cosine\centeredc\avg\audio\bysession\L1L2\visualization\permutations_tuned\solutionmaps\afni\nodestrength';
resultsdir = 'D:\MRI\SoundPicture\results\WholeBrain_RSA\wholebrain\semantic\featurenorms\cosine\centeredc\avg\audio\bysession\L1L2\visualization\final\solutionmaps\afni\nodestrength';
...
matlabbatch = cell(23, 1);
for s = 1:23
    matlabbatch{s}.spm.spatial.coreg.write.ref = {fullfile(resultsdir, 'rmean_audio.nii')};
