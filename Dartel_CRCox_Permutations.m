...
resultdir = 'D:\MRI\SoundPicture\results\ATLSearchlight\visual\permutations\solutionmaps\afni\error_centered_flipped';
...
matlabbatch = cell(23, 1);
for s = 1:23
    matlabbatch{s}.spm.spatial.coreg.write.ref = {fullfile(resultsdir, 'rmean_dartel_C.nii')};
